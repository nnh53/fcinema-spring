...
public class ShowtimeController {
    ...
    public ResponseEntity<ApiResponse<PageResponse<ShowtimeResponse>>> searchShowtimes(
        ...
        return ResponseEntity.ok(showtimeService.getShowtimesWithFilters(
                movieId, roomId, startDate, endDate, status, pageNo, pageSize));
    }

    @GetMapping("/movie/{movieId}")
    public ResponseEntity<ApiResponse<List<ShowtimeResponse>>> getShowtimesByMovie(@PathVariable Integer movieId) {
        return ResponseEntity.ok(showtimeService.getShowtimesByMovie(movieId));
    }

    @GetMapping("/room/{roomId}")
    public ResponseEntity<ApiResponse<List<ShowtimeResponse>>> getShowtimesByCinemaRoom(@PathVariable Integer roomId) {
