...
public class CinemaRoomController {
  ...
  @PostMapping
  public ResponseEntity<ApiResponse<CinemaRoomResponse>> create(
  ...
  @PutMapping("/{roomId}")
  public ResponseEntity<ApiResponse<CinemaRoomResponse>> update(
      @PathVariable Integer roomId, @RequestBody CinemaRoomUpdateRequest request) {
