...
public enum ErrorCode {
    ...
    INVALID_PROMOTION_STATUS_OR_TYPE(1020, "Loại hoặc Trạng thái không hợp lệ", HttpStatus.BAD_REQUEST),
    INVALID_ROOM_STATUS(1021, "Trạng thái phòng không hợp lệ", HttpStatus.BAD_REQUEST),
    INVALID_SEAT_TYPE(1022, "Loại ghế không hợp lệ", HttpStatus.BAD_REQUEST),
    INVALID_SEAT_STATUS(1023, "Trạng thái ghế không hợp lệ", HttpStatus.BAD_REQUEST),
    ;
    int code;
    String message;
