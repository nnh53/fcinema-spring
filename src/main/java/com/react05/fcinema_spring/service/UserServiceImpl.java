...
public class UserServiceImpl implements UserService {
  ...
  public ApiResponse<Void> updateUser(String id, UserUpdate userUpdate) {
    ...
    return ApiResponse.<Void>builder().code(200).message("User updated successfully").build();
  }
  ...
  public ApiResponse<Void> deleteUser(String id) {
    ...
    return ApiResponse.<Void>builder().code(200).message("User deleted successfully").build();
  }
